#!/usr/bin/env bash
# TWIST2 real-hardware launcher.
# No ROS dependency — UDP policy + motion library + G1 via unitree_interface.
#
# Usage:
#   TWIST2_MOTION_FILE=/path/to/motion.pkl \
#     [TWIST2_REAL_NET=eth0] \
#     ./deploy/play_real_twist2.sh [/path/to/model.onnx|model.pt]
#
...
# ---------------------------------------------------------------------------
# 3. Resolve network interface
# ---------------------------------------------------------------------------
NET="${TWIST2_REAL_NET:-eth0}"
